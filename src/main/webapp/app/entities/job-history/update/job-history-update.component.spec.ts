...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 11447 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 32390 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 620 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 23354 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 14546 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 15372 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 11241 };
      jobHistory.job = job;
      const department: IDepartment = { id: 23481 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 7083 };
      jobHistory.employee = employee;
