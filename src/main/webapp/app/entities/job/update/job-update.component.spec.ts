...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 14272 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 416 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 22421 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 10684 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 9407 };
      job.tasks = [task];
      const employee: IEmployee = { id: 20581 };
      job.employee = employee;
